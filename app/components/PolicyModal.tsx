      ...
      <div className="policy-modal">
        ...
        <div className="policy-modal-content" onScroll={handleScroll}>
          {isEnglish ? (
            ...
            <>
              ...
              <p>
                Үйлчилгээ нь хууль ёсны зорилгоор ашиглагдана.
              </p>
              ...
              <p>
                Хэрэглэгч имэйл хаяг болон Google, Facebook, Apple зэрэг нийгмийн сүлжээгээр дамжуулан нэвтрэх боломжтой.
        ...
        <div className="policy-modal-footer">
          ...
          {showApproveButton && (
            ...
            >
              {isEnglish ? 'I Agree & Approve' : 'Зөвшөөрөх'}
            </button>
          )}
        </div>
      </div>
